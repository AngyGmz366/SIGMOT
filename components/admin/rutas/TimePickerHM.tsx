...
const TimePickerHM: React.FC<TimePickerHMProps> = ({ value, onChange, error, label = 'Horario' }) => {
    ...
    return (
        <div>
            ...
            <InputText value={value} className={error ? 'p-invalid mt-2' : 'mt-2'} style={{ maxWidth: 120 }} readOnly />
